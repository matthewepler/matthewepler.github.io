...
![terminal on desktop]({{ site.url }}/images/piwallterminal.png) 
...
![default interfaces file]({{ site.url }}/images/piwallmanual.jpg)
...
![static IP config]({{ site.url }}/images/piwallstatic_IP.JPG)
...
![Pi's with sticky notes attached]({{ site.url }}/images/piwallsticky_notes.JPG)
...
These instructions are for the router recommended in the Materials list. 
 ...
 ![router info close up]({{ site.url }}/images/piwalltp-info-battery.JPG)
...
###Connecting and Configuration
 ...
 ![TP-Link setup screen]({{ site.url }}/images/piwalltp_quicksetup.png)
...
### Physical Connections
 ...
 ![router connection to switch]({{ site.url }}/images/piwallrouter_switch.JPG)
 ...
 ![Pis connected to switch]({{ site.url }}/images/piwallbeautiful_mess.JPG)
...
### SSH Communication
 ...
 ![ssh connection success]({{ site.url }}/images/piwallsshx4.png)
...
![ping results]({{ site.url }}/images/piwallping.png)
...
![new hostname]({{ site.url }}/images/piwallhostname.png)
...
![my screen measurements]({{ site.url }}/images/piwallmeasurements.png)
...
![filezilla screenshot]({{ site.url }}/images/piwallfilezilla_info.png)

Agree to the popup by checking the box and clicking "OK."

![filezilla alert popup]({{ site.url }}/images/piwallfilezilla_agree.png)
...
![filezilla drag and drop]({{ site.url }}/images/piwallfilezilla_find_file.png)
...
![filezilla confirm transfer]({{ site.url }}/images/piwallfilezilla_confirm.png)
