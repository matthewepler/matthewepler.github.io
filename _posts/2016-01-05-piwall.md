...
In the .piwall file, type in your measurements using this format:
	...
	[INSERT PIWALL TEXT HERE]

Copy this file to every Pi. You can use Filezilla (covered later in "Using FTP") or just copy/past to/from your computer and the Pi's. 
